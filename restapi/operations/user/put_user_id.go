...
type PutUserIDHandlerFunc func(PutUserIDParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn PutUserIDHandlerFunc) Handle(params PutUserIDParams, principal *models.Principal) middleware.Responder {
	return fn(params, principal)
}

// PutUserIDHandler interface for that can handle valid put user ID params
type PutUserIDHandler interface {
	Handle(PutUserIDParams, *models.Principal) middleware.Responder
}
