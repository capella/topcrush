...
type GetMatchsAllHandlerFunc func(GetMatchsAllParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn GetMatchsAllHandlerFunc) Handle(params GetMatchsAllParams, principal *models.Principal) middleware.Responder {
	return fn(params, principal)
}

// GetMatchsAllHandler interface for that can handle valid get matchs all params
type GetMatchsAllHandler interface {
	Handle(GetMatchsAllParams, *models.Principal) middleware.Responder
}
